...
class Location_links_Spider(scrapy.Spider):
    name = "Location_links"
    start_urls=["https://www.mubawab.ma/fr/sc/appartements-a-louer"]
...
class Location_data_Spider(scrapy.Spider):
    name = "Location_data"
    with open('4-location_links.json', 'r') as f:
        data= json.load(f)
